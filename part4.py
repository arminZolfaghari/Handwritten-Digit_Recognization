...
from part3 import update_W_b, calculate_cost, get_all_batches, sigmoid_derivative, initialize_grad_W_b
...
def start_learning_with_vectorization(dataset, number_of_epochs, batch_size, learning_rate):
...
if __name__ == "__main__":
    ...
    W1, W2, W3, b1, b2, b3, total_cost_arr_in_batch = start_learning_with_vectorization(train_set[0: number_of_images], number_of_epochs, batch_size, learning_rate)  # this W,b after learning
