...
if __name__ == "__main__":
    ...
    W1, W2, W3, b1, b2, b3, total_cost_arr_in_batch = start_learning_with_vectorization(train_set, number_of_epochs, batch_size, learning_rate)  # this W,b after learning
